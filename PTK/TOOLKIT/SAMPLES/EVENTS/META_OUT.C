      ...
      switch ( meta_buffer[0] )
      {
         ...
         case GDP:
            ...
            case VST_ROTATION:
               ...
               break;
            case VS_COLOR:
               vs_color ( vdi_handle, meta_buffer[4], &meta_buffer[5] );
               break;
            case VSL_TYPE:
            ...
            case VSL_END_STYLE:
               ...
               break;
            case VSF_UDPAT:
               vsf_udpat ( vdi_handle, &meta_buffer[4], meta_buffer[2] );
               break;
            case VSL_UDSTY:
            ...
            case VST_UNLOAD_FONTS:
               ...
               break;
            case VS_CLIPP:
               vs_clip ( vdi_handle, meta_buffer[8], &meta_buffer[4] );
               break;
         } /* end of switch */
