	...
	WORD		pwtemp[];
{
	...
	VOID
fun_msg(type, w3, w4, w5, w6, w7)
	WORD		type, w3, w4, w5, w6, w7;
{
...
/* */
 	  ...
 	  case AT_ISDISK:
		...
		{
		  spib = (ICONBLK *) get_spec(G.g_screen, pdf->f_obid);
...
*/
	VOID
fun_drag(src_wh, dst_wh, dst_ob, dulx, duly)
	WORD		src_wh;
	WORD		dst_wh;
	WORD		dst_ob;
	WORD		dulx, duly;
